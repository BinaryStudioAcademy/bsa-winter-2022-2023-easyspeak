...
{
    public partial class AddedSeedingOfCountriesLanguagesTmezonesForUser : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4L,
                columns: new[] { "Country", "Email", "FirstName", "ImagePath", "Language", "LanguageLevel", "LastName", "Sex", "Status", "Timezone" },
                values: new object[] { 0, "Eduardo.Larson@gmail.com", "Eduardo", "https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/1114.jpg", 0, 2, "Larson", 2, 0, 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5L,
                columns: new[] { "Country", "Email", "FirstName", "ImagePath", "IsSubscribed", "Language", "LanguageLevel", "LastName", "Sex", "Status", "Timezone" },
                values: new object[] { 0, "Francis16@yahoo.com", "Francis", "https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/607.jpg", true, 0, 2, "Little", 0, 0, 0 });
        }
    }
}
