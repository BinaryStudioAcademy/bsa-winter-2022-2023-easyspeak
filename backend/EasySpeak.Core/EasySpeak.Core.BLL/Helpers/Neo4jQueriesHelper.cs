...
public static class Neo4jQueriesHelper
{
    ...
    public static string AddClassQuery
        => @"MATCH (u: User { id: $id })
            ...
            MERGE (user)-[:SUBSCRIBED_ON]->(class)";
