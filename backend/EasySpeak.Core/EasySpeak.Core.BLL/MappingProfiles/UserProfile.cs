...
public class UserProfile : Profile
{
    public UserProfile()
    {
        ...
        CreateMap<User, UserShortInfoDto>()
            ...
            .ForMember(user => user.Country, src => src.ConvertUsing<EnumToStringValueConverter<Country>, Country>((user) => user.Country))
            .ForMember(user => user.Language, src => src.ConvertUsing<EnumToStringValueConverter<Language>, Language>((user) => user.Language))
